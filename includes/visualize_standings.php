<?php
	...
	$longPageContent .= '<div class="standings" id="east" style="width:100%;height:360px;"></div>';
	$longPageContent .= '<h2>Western Conference</h2>';
	$longPageContent .= '<div class="standings" id="west" style="width:100%;height:360px;"></div>';
?>
